...
static const char *fonts[]               = { 
  "JetBrainsMonoNL NFP:size=16:style=Bold", 
...
static const Key keys[] = {
  ...
  /* custom  */
    ...
    { MODKEY|ShiftMask,             XK_k,                       spawn,          SHCMD("slack") },
    { MODKEY|ShiftMask,             XK_z,                       spawn,          SHCMD("zoom") },
    { MODKEY|ShiftMask,             XK_l,                       spawn,          SHCMD("ledger-live") },
    { MODKEY|ShiftMask,             XK_u,                       spawn,          SHCMD("UnityHub") },
    { MODKEY|ShiftMask,             XK_v,                       spawn,          SHCMD("/opt/discord/Discord") },
	{ 0,                            XF86XK_AudioMute,           spawn,          SHCMD("pactl set-sink-mute @DEFAULT_SOURCE@ toggle") },
    ...
    { ControlMask,                  XK_Print,                   spawn,          SHCMD("maim --select | xclip -selection clipboard -t image/png") },
